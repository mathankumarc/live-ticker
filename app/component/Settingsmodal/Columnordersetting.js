                ...
                <div className="settings-section">
                    ...
                    <div className="settings-option">
                        <div className="option-row">
                            <div onClick={this.setColumnOrder.bind(this, 0)} className={"radio-circle " + (this.props.currentColumnOrderOption === 0 ? 'selected' : '')}></div>
                            <div>
...
const mapStateToProps = (state) => {
    return {currentColumnOrderOption: state.bookColumnOrderSetting};
}
