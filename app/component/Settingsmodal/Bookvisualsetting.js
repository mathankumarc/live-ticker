      ...
      <div className="settings-section">
        ...
        <div className="settings-option">
          <div className="option-row">
            <div onClick={setBookVisualToCumulative} className={`radio-circle ${isCumulativeSelected ? 'selected' : ''}`} />
            Cumulative (default)
          </div>
          <div className="option-row">
            <div onClick={setBookVisualToAmount} className={`radio-circle ${!isCumulativeSelected ? 'selected' : ''}`} />
            Amount
          </div>
        </div>
      </div>
