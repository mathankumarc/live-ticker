...
import {
  BOOK_TYPES, FLOAT_PRECISION_LENGTH, COLUMN_ORDER_VALUES, SOCKET_CONNECTION_CONSTANTS,
  ...
  return (
    <div id="book-asks-container" className="book-side">
      ...
      {!isLoading && asksPrices.length && asksPrices.slice(0, 24).map((price, index) => {
        ...
        return (<Bookrow key={index} type="asks" data={asks[price]} total={cumulativeTotal} />);
      })}
